...
- Support importing a Dashboard artifact generated by the CLI.

### v0.7: Evaluation coverage and reproducible demo (complete)

- Expand the deterministic suite to 36 tasks spanning five support intent categories.
- Add critical-task coverage for business-sensitive refund flows.
